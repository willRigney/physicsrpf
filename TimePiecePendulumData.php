...
if($scenario==5){
	header("Location: TimePieceScenario1-4Error.html");
	exit;
	}
elseif($scenario==1 && is_numeric($_GET['1a']) && is_numeric($_GET['2a']) && is_numeric($_GET['2b']) && is_numeric($_GET['3a']) && is_numeric($_GET['3b'])
		&& is_numeric($_GET['4a']) && is_numeric($_GET['4b']) && is_numeric($_GET['5a']) && is_numeric($_GET['5b']) && is_numeric($_GET['8a'])
		&& is_numeric($_GET['8b']) && is_numeric($_GET['9a']) && is_numeric($_GET['9b']) && $_GET['2a']!=0 && $_GET['1a']!=0){
	$total=10;
	$dF=.3;
	}
elseif($scenario==2 && is_numeric($_GET['1a']) && is_numeric($_GET['2a']) && is_numeric($_GET['2b']) && is_numeric($_GET['3a']) && is_numeric($_GET['3b'])
		&& is_numeric($_GET['4a']) && is_numeric($_GET['4b']) && is_numeric($_GET['5a']) && is_numeric($_GET['5b']) && is_numeric($_GET['6a'])
		&& is_numeric($_GET['6b']) && is_numeric($_GET['7a']) && is_numeric($_GET['7b']) && is_numeric($_GET['8a']) && is_numeric($_GET['8b'])
		&& is_numeric($_GET['8c']) && is_numeric($_GET['9a']) && is_numeric($_GET['9b']) && is_numeric($_GET['9c']) && $_GET['2a']!=0 && $_GET['1a']!=0){
	$total=16;
	$dF=.5;
	}
elseif($scenario==3 && is_numeric($_GET['1a']) && is_numeric($_GET['2a']) && is_numeric($_GET['2b']) && is_numeric($_GET['2d']) && is_numeric($_GET['3a'])
		...
		&& is_numeric($_GET['9c']) && $_GET['2a']!=0 && $_GET['1a']!=0){
	$total=18;
	$dF=.7;
	}
elseif($scenario==4 && is_numeric($_GET['1a']) && is_numeric($_GET['2a']) && is_numeric($_GET['2b']) && is_numeric($_GET['2d']) && is_numeric($_GET['3a'])
		&& is_numeric($_GET['3b']) && is_numeric($_GET['3d']) && is_numeric($_GET['4a']) && is_numeric($_GET['4b']) && is_numeric($_GET['5a'])
		&& is_numeric($_GET['5b']) && is_numeric($_GET['6a']) && is_numeric($_GET['6b']) && is_numeric($_GET['7a']) && is_numeric($_GET['7b'])
		&& is_numeric($_GET['8a']) && is_numeric($_GET['8b']) && is_numeric($_GET['8c']) && is_numeric($_GET['9a']) && is_numeric($_GET['9b'])
		&& is_numeric($_GET['9c']) && is_numeric($_GET['10a']) && is_numeric($_GET['10b']) && $_GET['2a']!=0 && $_GET['1a']!=0){
	$total=20;
	$dF=.9;
	}
else{
...
<form>
	<table border="1">
		...
		<tr>
			...
			<td>m</td>
			<?php
			if((pow($_GET['1a'],2)*9.81/(4*pow(3.14159,2)))*.9 <= $_GET['2a'] && $_GET['2a'] <=
					(pow($_GET['1a'],2)*9.81/(4*pow(3.14159,2)))*1.1){
			...
			<?php echo $_GET['2a'];?></td>
			<?php
			if((9.81/(4*pow(3.14159,2)))*.9 <= $_GET['2b'] && $_GET['2b'] <= (9.81/(4*pow(3.14159,2)))*1.1){
				echo "<td class='correct'>";
				$correct++;
				}
			else{
			...
			<td class="fixed"></td>
			<?php
			if(((9.81/6)/(4*pow(3.14159,2)))*.9 <= $_GET['2d'] && $_GET['2d'] <= ((9.81/6)/(4*pow(3.14159,2)))*1.1 && $scenario>=3){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=3){
		...
		<tr>
			...
			<td class="fixed"></td>
			<?php
			if(($_GET['3b'])*.9 <= $_GET['3d'] && $_GET['3d'] <= ($_GET['3b'])*1.1 && $scenario>=3){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=3){
		...
		<tr>
			...
			<td>m/s</td>
			<?php
			if(($_GET['4a']*$_GET['5a'])*.9 <= $_GET['6a'] && $_GET['6a'] <= ($_GET['4a']*$_GET['5a'])*1.1 && $scenario>=2){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=2){
			...
			<?php echo $_GET['6a'];?></td>
			<?php
			if(($_GET['4b']*$_GET['5b'])*.9 <= $_GET['6b'] && $_GET['6b'] <= ($_GET['4b']*$_GET['5b'])*1.1 && $scenario>=2){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=2){
		...
		<tr>
			...
			<td>m/s<sup>2</sup></td>
			<?php
			if(($_GET['5a']*pow($_GET['4a'],2))*.9 <= $_GET['7a'] && $_GET['7a'] <= ($_GET['5a']*pow($_GET['4a'],2))*1.1 && $scenario>=2){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=2){
			...
			<?php echo $_GET['7a'];?></td>
			<?php
			if(($_GET['5b']*pow($_GET['4b'],2))*.9 <= $_GET['7b'] && $_GET['7b'] <= ($_GET['5b']*pow($_GET['4b'],2))*1.1 && $scenario>=2){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario>=2){

...
<?php
	...
	/********************************************Column 1***********************************************************************************/
	if(isset($_POST['Snum1'])) //&& is_numeric($_POST['Snum1']))
		$Snum1 = $_POST['Snum1'];
	else{
	...
	/********************************************Column 2***********************************************************************************/
	if(isset($_POST['Snum2'])) //&& is_numeric($_POST['Snum2']))
		$Snum2 = $_POST['Snum2'];
	else{
		header("Location: BarrelJumpError.html");
		exit;
	...
	/********************************************Column 3***********************************************************************************/
	if(isset($_POST['Snum3'])) //&& is_numeric($_POST['Snum3']))
		$Snum3 = $_POST['Snum3'];
	else{
		header("Location: BarrelJumpError.html");
		exit;
	...
	/********************************************Column 4***********************************************************************************/
	if(isset($_POST['Snum4'])) //&& is_numeric($_POST['Snum4']))
		$Snum4 = $_POST['Snum4'];
	else{
		header("Location: BarrelJumpError.html");
		exit;
	...
	/********************************************Column 5***********************************************************************************/
	if(isset($_POST['Snum5'])) //&& is_numeric($_POST['Snum5']))
		$Snum5 = $_POST['Snum5'];
	else{
		header("Location: BarrelJumpError.html");
		exit;
...
<table border="1">
	<tr>
		...
		<td><u>Average Measured</u><br>Distance from Table (x) [m]</td>
		...
		<td><u>Calculated</u><br>Distance From Table (x) [m] (2 points)</td>
		<td>% Error (1 point)</td>
	</tr>
	
	<!--Column 1-->
	<tr>
		<td class="normal"><?php echo $Snum1?></td>
	...
	<!--Column 2-->
	<tr>
		<td class="normal"><?php echo $Snum2?></td>
	...
	<!--Column 3-->
	<tr>
		<td class="normal"><?php echo $Snum3?></td>
	...
	<!--Column 4-->
	<tr>
		<td class="normal"><?php echo $Snum4?></td>
	...
	<!--Column 5-->
	<tr>
		<td class="normal"><?php echo $Snum5?></td>
...
<div>
	...
	<br>
	Correct: <?php echo $correct.' out of 25'?>
	<br>
	Score: <?php echo $score.' out of 30, which is '.round((($score/30)*100)).'%' ?>
</div>
<?php
...
$handle=fopen("results/BarrelJumpAnswers.csv","a");
	fwrite($handle, $period.",".$lname.",".$fname.",".round((($score/30)*100))."%,".$score.",".$correct.",".date('D d M Y H:i:s').",".$Snum1.",".$a1.",".$b1.",".$c1.",".$d1.",".$e1.",".$f1.",".$g1.",".$h1.",".$i1.','.$Snum2.",".$a2.",".$b2.",".$c2.",".$d2.",".$e2.",".$f2.",".$g2.",".$h2.",".$i2.",".$Snum3.",".$a3.",".$b3.",".$c3.",".$d3.",".$e3.",".$f3.",".$g3.",".$h3.",".$i3.",".$Snum4.",".$a4.",".$b4.",".$c4.",".$d4.",".$e4.",".$f4.",".$g4.",".$h4.",".$i4.",".$Snum5.",".$a5.",".$b5.",".$c5.",".$d5.",".$e5.",".$f5.",".$g5.",".$h5.",".$i5);
	fwrite($handle,"\n");

...
<form>
	<table border="1">
		...
		<tr>
			<td>Scenario (for Scenario 4, only record the values for the 2-bulb position)</td>
		...
		<tr>
			<td>Bulb 1</td>
			<td class="fixed">10 &#937;</td>
			<td><?php echo $_GET['2b'];?></td>
			<?php
			if($scenario<5 && ($_GET['2b']*10)*.95<=$_GET['2c'] && $_GET['2c']<=($_GET['2b']*10)*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario<5){
			...
			<?php echo $_GET['2c'];?></td>
			<?php
			if($scenario<5 && pow($_GET['2b'],2)*10*.95<=$_GET['2d'] && $_GET['2d']<=pow($_GET['2b'],2)*10*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario<5){
		...
		<tr>
			...
			<?php
			if($scenario==4 && $_GET['3b']*10*.95<=$_GET['3c'] && $_GET['3c']<=$_GET['3b']*10*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario==4){
			...
			<?php echo $_GET['3c'];?></td>
			<?php
			if($scenario==4 && pow($_GET['3b'],2)*10*.95<=$_GET['3d'] && $_GET['3d']<=pow($_GET['3b'],2)*10*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario==4){
		...
		<tr>
			...
			<?php
			if($scenario==4 && $_GET['4b']*10*.95<=$_GET['4c'] && $_GET['4c']<=$_GET['4b']*10*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario==4){
			...
			<?php echo $_GET['4c'];?></td>
			<?php
			if($scenario==4 && pow($_GET['4b'],2)*10*.95<=$_GET['4d'] && $_GET['4d']<=pow($_GET['4b'],2)*10*1.05){
				echo "<td class='correct'>";
				$correct++;
				}
			elseif($scenario==4){
...
<p id="right">Version 1.4 Last Updated 3/14/2019 AKH</p>
